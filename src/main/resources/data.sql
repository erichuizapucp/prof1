...
insert into merchandising(nombre, descripcion, precio)
values ('Gorra Mercedez', 'Gorra Mercedez del equipo', 150.00);
insert into merchandising(nombre, descripcion, precio)
values ('Camiseta Ferrari', 'Camiseta del equipo Ferrari', 250.00);
insert into merchandising(nombre, descripcion, precio)
values ('Camiseta Mercedez', 'Camiseta del equipo Mercedez', 250.00);